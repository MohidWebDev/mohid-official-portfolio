      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            >
              Building Robust <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-[#00f2fe] via-[#00e1fe] to-[#10b981]">
                Scalable Digital <br />
                Solutions.
              </span>
            </motion.h1>
            ...
            >
              ...
              applications. Crafting the digital infrastructure of tomorrow with
          ...
          <div className="lg:col-span-6 flex flex-col justify-center gap-6 sm:gap-10 lg:gap-12 w-full pt-4">
            ...
            <motion.div
              ...
              className="self-start w-full max-w-95 sm:max-w-102.5 bg-[#161b22]/90 backdrop-blur-md border border-cyan-500/20 rounded-xl p-5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] shadow-cyan-950/20 hover:border-cyan-500/40 transition-all duration-300 animate-float-slow z-10"
            >
              {/* Window Controls */}
            ...
            <motion.div
              ...
              className="self-end w-full max-w-95 sm:max-w-102.5 bg-[#161b22]/90 backdrop-blur-md border border-cyan-500/20 rounded-xl p-5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] shadow-cyan-950/20 hover:border-cyan-500/40 transition-all duration-300 animate-float-reverse z-10"
            >
              {/* Window Controls */}
              <div className="flex items-center justify-between pb-3 border-b border-slate-800/80 mb-3">
                <div className="flex items-center gap-1.5">
              ...
              <pre className="font-code hero-code-snippet text-xs sm:text-sm leading-relaxed text-slate-300 overflow-x-auto">
                <code className="font-code">
                  <span className="text-purple-400 font-semibold">const</span>{" "}
                  express = <span className="text-blue-400">require</span>(
