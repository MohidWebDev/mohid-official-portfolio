          ...
          <div className="border-b border-slate-800 pb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-cyan-400 font-mono text-sm mt-1">
                San Francisco, CA • hello@architect.io
              </p>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {TECH_CATEGORIES.map((cat) => (
                <div
                  key={cat.id}
                  className="bg-[#0d1117] p-3.5 rounded-lg border border-slate-800"
                >
          ...
          <div>
            ...
            <div className="space-y-6">
              {EXPERIENCES.map((exp) => (
                <div
                  key={exp.id}
                  className="border-l-2 border-cyan-500/40 pl-4 space-y-1"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2 border-t border-slate-800">
            <div>
              ...
              <ul className="space-y-2 text-xs text-slate-400">
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    B.S. Computer Science — University of Technology (Honors)
                  </span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Dedicated to designing resilient, low-latency microservices with
                automated testing, continuous delivery pipelines, and elegant,
